      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-5 flex items-center justify-between border-t border-pharmacare-line pt-4">
          <div className="flex overflow-hidden rounded-lg border border-pharmacare-line bg-pharmacare-low">
            <button className="px-3 text-pharmacare-muted hover:bg-white" aria-label="Decrease quantity">
              <Minus size={16} />
            </button>
            <span className="border-x border-pharmacare-line bg-white px-4 py-1.5 text-sm font-semibold text-pharmacare-ink">
              {item.quantity}
            </span>
            <button className="px-3 text-pharmacare-muted hover:bg-white" aria-label="Increase quantity">
              <Plus size={16} />
            </button>
          </div>
          <button className="inline-flex items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-pharmacare-danger hover:bg-pharmacare-dangerSoft">
            <Trash2 size={16} />
            Remove
          </button>
        </div>
