...
SECRET_KEY = os.environ.get("DJANGO_SECRET_KEY", "order_service-dev-secret-key")
...
PAYMENT_SERVICE_TIMEOUT_SECONDS = float(os.environ.get("PAYMENT_SERVICE_TIMEOUT_SECONDS", "5"))
SHIPPING_SERVICE_URL = os.environ.get("SHIPPING_SERVICE_URL", "http://localhost:8005")
SHIPPING_SERVICE_TIMEOUT_SECONDS = float(os.environ.get("SHIPPING_SERVICE_TIMEOUT_SECONDS", "5"))
